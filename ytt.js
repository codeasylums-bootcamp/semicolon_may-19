...
function x() {
    ...
    axios.get("https://www.googleapis.com/youtube/v3/search?part=snippet&q=" + `${final}` + "&type=video&key=AIzaSyCVg8QjFEyWIls8WTFWbjr-qcLwZoYKDdU")
